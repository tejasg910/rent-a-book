...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-900 shadow-xl fixed w-full z-20 ">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    <a href="https://flowbite.com/" class="flex items-center">
  
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">BOOK A BOOK</span>
    </a>
